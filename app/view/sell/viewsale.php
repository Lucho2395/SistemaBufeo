                    ...
                    if($totales == 0){
                        ...
                        foreach ($productssale as $p){
                            ...
                            <tr>
                                ...
                                <td><?php echo $p->sale_productstotalselled;?></td>
                                <td><?php echo $p->sale_productname;?></td>
                                <td>S/. <?php echo $p->sale_price;?></td>
