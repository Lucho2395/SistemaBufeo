...
<div class="content-wrapper">
    ...
    <section class="content" style="background-color: white;box-shadow: 10px 10px 5px #888888;border-radius: 30px; padding: 15px; margin: 50px; min-height: 500px">
        ...
        <div class="row">
            ...
            <div class="col-xs-3">
                <br>
                <a class="btn btn-warning" type="button" onclick="buscar_producto_barcode()" ><i class="fa fa-search"></i> Buscar</a> <!--onchange="buscar()"-->
            </div>
        </div>
        <div class="row">
            <div class="col-xs-1"></div>
...
<script type="text/javascript">
    ...
    function buscar_producto_barcode() {
        ...
        if (valor == "correcto"){
            ...
            $.ajax({
                type:"POST",
                url: urlweb + "api/Sell/search_by_barcode",
                data: cadena,
                success:function (r) {
                    if(r=="2"){
