...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Inventario
            <small>Editar Egreso</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Egreso</a></li>
            <li><a href="#">Editar Egreso</a></li>
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Egreso a Editar</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="expense_mont" placeholder="Ingresar Monto" value="<?php echo $expense->expense_mont;?>" onkeypress="return valida(event)">
                            </div>
                            <div class="form-group">
