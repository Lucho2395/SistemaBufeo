...
class Report{
    ...
    try{
        ...
        $this->log->insert($e->getMessage(), 'Report|stockout');
        $result = 0;
    }
    return $result;
}
public function stockout_dates($fecha_i,$fecha_f, $id_product){
    ...
    public function all_saleproduct($turn){
        try{
            ...
            $this->log->insert($e->getMessage(), 'Report|all_saleproduct');
            $result = 0;
        }
        return $result;
    }
    ...
    public function kardex_product_dates_sales($fecha_i,$fecha_f,$producto){
        try{
            ...
            $this->log->insert($e->getMessage(), 'Report|kardex_product_dates_sales');
            $result = 0;
        }
        return $result;
    }
    ...
    public function kardex_product_dates_stockout($fecha_i,$fecha_f,$producto){
        try{
            ...
            $this->log->insert($e->getMessage(), 'Report|kardex_product_dates_stockout');
            $result = 0;
        }
        return $result;
    }
