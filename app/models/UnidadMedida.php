...
class UnidadMedida
{
    ...
    public function listAllactivo(){
        try{
            ...
            $this->log->insert($e->getMessage(), 'UnidadMedida|listProducts');
            $result = 2;
        }
    ...
    public function listAll()
    {
        try {
            ...
            $this->log->insert($e->getMessage(), 'Admin|listProducts');
            $result = 2;
        }
        return $result;
    }
    ...
    public function cambiar_estado($estado , $id_medida ){
        try {
            $sql = 'update medida set medida_activo = ? where medida_id = ?';
            $stm = $this->pdo->prepare($sql);
            $stm->execute([
                $estado,
                $id_medida
